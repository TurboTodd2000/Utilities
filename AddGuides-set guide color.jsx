...
// varmyLayers = [];
// var myLayerList = myDocument.layers.name;
        ...
        with(dialogColumns.add()){  
            ...
            with(borderPanels.add()){  
                ...
                with(dialogColumns.add()){                      
                    ...
                    var myXCenterCheckbox = checkboxControls.add({staticLabel:"&Horizontal Center", checkedState:false});  

                    var myYCenterCheckbox = checkboxControls.add({staticLabel:"&Vertical Center", checkedState:false});  
            ...
            with(borderPanels.add()){  
             ...
             with(borderPanels.add()){    
                ...
                staticTexts.add({staticLabel:"Guide Color:"});    

                with(myColorRangeButtons = radiobuttonGroups.add()){    

                    radiobuttonControls.add({staticLabel:"Red", checkedState:true, minWidth:156});    

                    radiobuttonControls.add({staticLabel:"Blue"});   

                    radiobuttonControls.add({staticLabel:"Black"});   
...
//added layer selection
            ...
            //     staticTexts.add({staticLabel:"Layer to put guides on:"});    

            //     //with(myLayers = dropdowns.add({stringList:myLayerList, selectedIndex:0});){    
    ...
    if (myReturn == true){  
        ...
        var myColorRange = myColorRangeButtons.selectedButton;  

        switch (myColorRange){

            case 0:
                //red?
                MY_GUIDE_COLOR = [255, 0, 0]

                break;

            case 1:
                //green?
                MY_GUIDE_COLOR = [0, 0, 255]

                break;

            case 2:
                //black
                MY_GUIDE_COLOR = [0, 0, 0]

                break;

            case 3:
                //green
                MY_GUIDE_COLOR = [0, 255, 0]
...
function myDisplayScriptUIDialog(myObjectList){  
    ...
    with(myDialog){  
        ...
        var myColorGuideLocationPanel = add('panel', undefined, "Guide Colors:");    

        with(myColorGuideLocationPanel){    

            orientation = 'column';    

            guideColor = [255,255,150] ;   
            ...
            myDialog.myEachObjectRadioButton = add('radiobutton', undefined, "Red");    

            myDialog.myEachObjectRadioButton.value = false;    

            myDialog.myEntireSelectionRadioButton = add('radiobutton', undefined, "Blue");    

            myDialog.myEntireSelectionRadioButton = add('radiobutton', undefined, "Black");  
